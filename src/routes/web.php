...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/admin/newsletter/create', ['App\Http\Controllers\Admin\NewsletterManagementController', 'createPage'])->name('admin.newsletter.create');
        Route::post('/admin/newsletter/create', ['App\Http\Controllers\Admin\NewsletterManagementController', 'create'])->name('admin.newsletter.create');
